            ...
            <div class="note-editor note-frame card">
                            ...
                            <div class="note-dropdown-menu dropdown-menu note-check dropdown-fontname"
                                role="list" aria-label="Font Family"><a
                                    ...
                                    aria-label="Arial Black"><i
                                        ...
                                        Black</span></a><a class="dropdown-item" href="#"
                                    ...
                                    aria-label="Segoe UI"><i
                                        class="note-icon-menu-check"></i> <span
                                        style="font-family: 'Segoe UI'">Segoe
                                        UI</span></a><a class="dropdown-item" href="#"
                                    ...
                                    aria-label="Segoe UI Symbol"><i
                                        class="note-icon-menu-check"></i> <span
                                        style="font-family: 'Segoe UI Symbol'">Segoe UI
                                        Symbol</span></a></div>
                        </div>
                    </div>
                            ...
                            <div class="note-dropdown-menu dropdown-menu" role="list">
                                <div class="note-palette">
                                    ...
                                    <div><button type="button"
                                            ...
                                            data-value="backColorPicker-16364145930751">Select</button><input
                                            type="color" id="backColorPicker-16364145930751"
                                            class="note-btn note-color-select-btn"
                                            value="#FFFF00"
                                            data-event="backColorPalette-16364145930751">
                                    </div>
                                    <div class="note-holder-custom"
                                        id="backColorPalette-16364145930751"
                                        data-event="backColor">
                                        <div class="note-color-palette">
                                            <div class="note-color-row"><button
                                                    type="button" class="note-color-btn"
                                ...
                                <div class="note-palette">
                                    ...
                                    <div><button type="button"
                                            class="note-color-select btn btn-light btn-default"
                                            data-event="openPalette"
                                            data-value="foreColorPicker-16364145930751">Select</button><input
                                            type="color" id="foreColorPicker-16364145930751"
                                            class="note-btn note-color-select-btn"
                                            value="#000000"
                                            data-event="foreColorPalette-16364145930751">
                                    </div>
                                    <div class="note-holder-custom"
                                        id="foreColorPalette-16364145930751"
                                        data-event="foreColor">
                                        <div class="note-color-palette">
                                            <div class="note-color-row"><button
                                                    type="button" class="note-color-btn"
                ...
                <div class="note-editing-area">
                    ...
                    <div class="note-editable card-block" contenteditable="true"
                        ...
                        autocorrect="true"> Place <em>some</em> <u>text</u>
                        <strong>here</strong>
                    </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-group note-form-group"><label
                                        for="note-dialog-link-txt-16364145930751"
                                        class="note-form-label">Text to
                                        display</label><input
                                        id="note-dialog-link-txt-16364145930751"
                                        class="note-link-text form-control note-form-control note-input"
                                        type="text"></div>
                                <div class="form-group note-form-group"><label
                                        for="note-dialog-link-url-16364145930751"
                                        class="note-form-label">To what URL should this
                                        link go?</label><input
                                        id="note-dialog-link-url-16364145930751"
                ...
                <div class="modal note-modal" aria-hidden="false" tabindex="-1"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div
                                    ...
                                    <label for="note-dialog-image-file-16364145930751"
                                        class="note-form-label">Select from
                                        files</label><input
                                        id="note-dialog-image-file-16364145930751"
                                ...
                                <div class="form-group note-group-image-url"><label
                                        for="note-dialog-image-url-16364145930751"
                                        class="note-form-label">Image URL</label><input
                                        id="note-dialog-image-url-16364145930751"
                ...
                <div class="note-popover popover in note-table-popover bottom">
                    ...
                    <div class="popover-content note-children-container">
                        ...
                        <div class="note-btn-group btn-group note-delete"><button
                                type="button" class="note-btn btn btn-light btn-sm btn-md"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-group note-form-group row-fluid"><label
                                        for="note-dialog-video-url-16364145930751"
                                        class="note-form-label">Video URL <small
                                            class="text-muted">(YouTube, Google Drive,
                                            Vimeo, Vine, Instagram, DailyMotion, Youku,
                                            Peertube)</small></label><input
                                        id="note-dialog-video-url-16364145930751"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <p class="text-center"><a href="http://summernote.org/"
                                        target="_blank" rel="noopener noreferrer">Summernote
                                        0.8.20</a> · <a
